export const settingsChangelog = [
  {
    ver: 'v10.7.9.212', date: '2026-07-08', latest: true,
    items: [
      '₿ BTC 小曲线视觉降噪',
      '  - BTC 价格和 LIVE 实时状态继续秒级更新,但小曲线不再把几分钱或几美元波动强行拉满高度',
      '  - BTC 小曲线新增独立最小视觉区间,真实大波动仍正常绘制,轻微波动显示为更接近水平线',
      '  - 本次只改首页 BTC 卡片小曲线渲染比例,不改 BTC WebSocket、三大指数、股票交易行情、持仓盈亏、数据库、RLS 或鉴权边界',
    ],
  },
  {
