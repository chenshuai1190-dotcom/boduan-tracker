export const settingsChangelog = [
  {
    ver: 'v10.7.9.240', date: '2026-07-09', latest: true,
    items: [
      '🧹 数据初始化功能',
      '  - 设置页新增数据初始化卡片,需要二次确认后才会执行,并明确提示操作不可恢复',
      '  - 初始化会清空当前登录账号的交易记录、自选、资产、目标、复盘、摊薄工具、收益报表快照和本地缓存',
      '  - 登录账号、邀请码、服务端配置、行情 relay、RLS 和 /api/quote 鉴权不受影响',
    ],
  },
  {
