export const settingsChangelog = [
  {
    ver: 'v10.7.9.174', date: '2026-07-06', latest: true,
    items: [
      '📈 股票昨收兜底和当日盈亏修复',
      '  - EODHD 实时报价有最新价但缺昨收时,改用 EODHD EOD 历史补昨收',
      '  - 当 EODHD 返回空 0 涨跌字段但价格和昨收不同,自动重算涨跌额和涨跌幅',
      '  - 前端行情合并不再让空 0 涨跌幅覆盖已有有效 baseline',
      '  - 不改交易账本、持仓数量、成本、Yahoo 小曲线、行情 relay、RLS 或鉴权',
    ],
  },
  {
