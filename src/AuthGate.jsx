...
function LoadingScreen() {
  return (
    <div className="min-h-screen bg-[#05070b] flex items-center justify-center px-6">
      <div className="loading-mascot-stage" role="status" aria-label="加载中">
        <span className="loading-mascot-glow" aria-hidden="true" />
        <span className="loading-mascot-orbit" aria-hidden="true" />
        <img
          ...
          decoding="async"
          fetchPriority="high"
          className="loading-mascot-image"
        />
      </div>
    </div>
  );
