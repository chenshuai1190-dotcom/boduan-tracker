...
const FIXTURES = {
  NVDA: {
    ...
    zh: {
      ...
      checks: [
        ...
        { label: '动量', reading: 'RSI (6) 中性', metric: '54.2', detail: 'RSI 回到中性区间，样例中未出现已确认的顶背离。' },
      ],
    ...
    en: {
      ...
      checks: [
        ...
        { label: 'Momentum', reading: 'RSI (6) neutral', metric: '54.2', detail: 'RSI has returned to its neutral range. This scenario has no confirmed bearish divergence.' },
      ],
  ...
  META: {
    ...
    zh: {
      ...
      reasons: ['RSI (6) 高于 80，且顶背离已确认', '距离下一压力约 1.7%'],
      trendLabel: '上涨中的动量减弱',
      checks: [
        ...
        { label: '动量', reading: '超买 · 顶背离', metric: 'RSI (6) 82.4', detail: '两次价格高点从 $660.00 升至 $686.40，对应 RSI 从 91.2 降至 85.1；第二高点已完成后续两根日线确认，当前 RSI 为 82.4。' },
      ],
    ...
    en: {
      ...
      reasons: ['RSI (6) exceeds 80 with confirmed bearish divergence', 'The next resistance is about 1.7% away'],
      ...
      checks: [
        ...
        { label: 'Momentum', reading: 'Overbought · divergence', metric: 'RSI (6) 82.4', detail: 'Price peaks rose from $660.00 to $686.40 while their RSI readings fell from 91.2 to 85.1. Two subsequent daily bars confirmed the second peak; current RSI is 82.4.' },
      ],
  ...
  MSFT: {
    ...
    zh: {
      ...
      checks: [
        ...
        { label: '动量', reading: 'RSI (6) 中性', metric: '68.3', detail: 'RSI 未进入本工具的 80 以上超买区间，样例中未出现已确认的顶背离。' },
      ],
    ...
    en: {
      ...
      checks: [
        ...
        { label: 'Momentum', reading: 'RSI (6) neutral', metric: '68.3', detail: 'RSI remains below this tool’s overbought threshold of 80. This scenario has no confirmed bearish divergence.' },
      ],
