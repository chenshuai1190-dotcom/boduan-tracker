...
- Deployment:
  ...
  - 本文件所在 deployment retry/status commit 将继续使用项目 SSH key 推送到 GitHub `main`,触发 GitHub-integrated Vercel deployment 重试;若 Vercel 仍返回 rate limit,生产仍保持 `v10.7.9.182`。
