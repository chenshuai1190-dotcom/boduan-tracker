...
- 本地与生产设置页版本均为 `v10.7.9.328`;生产运行时基准为 `5ec2c43d4bfe166b2b475fdf294f4cd3c1eb2399`,入口 `/assets/index-DDCYvKoc.js`。
...
- 当前本地和生产设置页版本均为 `v10.7.9.328`。v328 统一个股/QQQ 普通收盘价口径,补齐紧凑的收益率差百分比展示并取消分享卡外层白框;v327 新增个股收益与 QQQ 真实同期现金流对比,同一生产 runtime 包含 v326 真实收盘涨跌榜和已添加减号修复。
