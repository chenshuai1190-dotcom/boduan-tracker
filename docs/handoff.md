...
- 最新接手补充: `v10.7.9.279` 首页股票文字继续降重已由 runtime commit `d086188db6a33fa7a3b9fbe0a6298aa48350867b` 部署并完成线上验证。本轮把“切换基准”菜单里的股票代码取消粗体,并把首页“自选”和“持仓”两个 tab 标题取消粗体;只改首页展示层、设置页版本/更新日志和静态护栏,行情接口、交易账本、收益快照、财报日历、RLS、独立 `/api/earnings-calendar` 鉴权和 `/api/quote` 鉴权不变。上一条 `v10.7.9.278` 首页当前信号文字降重已由 runtime commit `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 部署并完成线上验证。
...
- 当前 GitHub `main`: 以本文件所在最新提交为准;`v10.7.9.279` 首页股票文字继续降重 runtime commit `d086188db6a33fa7a3b9fbe0a6298aa48350867b` 已完成 production 验证。
...
- 最近交接文档刷新部署: 本文件所在最新提交为准;本次回填 `v10.7.9.279` runtime production 验证证据。
...
- 当前生产运行时基准提交: `d086188db6a33fa7a3b9fbe0a6298aa48350867b`。
- 最近应用代码提交: `d086188db6a33fa7a3b9fbe0a6298aa48350867b` 包含 `v10.7.9.279` 首页股票文字继续降重。此前 `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 包含 `v10.7.9.278` 首页当前信号文字降重;更早收益报表、个股详情、财报日历、BTC/指数拆分和 iOS 主屏实时链路历史见开发日志。
...
- 最近交接文档刷新部署: 本文件所在最新提交为准;本次 docs-only follow-up 只同步 `v10.7.9.279` runtime production 验证证据。
...
当前 GitHub main: 以 `docs/handoff.md` 所在最新提交为准;`v10.7.9.279` runtime commit `d086188db6a33fa7a3b9fbe0a6298aa48350867b` 已完成 production 验证
