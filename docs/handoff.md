...
- 当前本地与生产均为 `v10.7.9.313`。v313 只改头像视觉和头卡提示文字;不改头像 key、社区资料、比赛、交易账本或数据库逻辑。
...
- 当前本地与生产设置页版本均为 `v10.7.9.313`。生产运行时基准提交为 `e37bd8643c68f928b58919114c6bb72a6cea351e`,入口 `/assets/index-CgpI3hB0.js`。
...
- 当前本地与生产设置页版本均为 `v10.7.9.313`;v313 仅修正头像裁切、尺寸和头卡提示文字。v312 的 18 款头像与生产约束迁移/回查继续有效;匿名 REST 20/20 和线上鉴权证据不变。
