...
- 当前已验证 production runtime 为 `b9b213cd70a1689948abe060f818fb178d18ab97`,入口 `/assets/index-7-QkVfBC.js`;GitHub Actions run `29290092289` 与 Vercel target `ApuefMFcjKxa37HrUPVmeACc5J6S` success。
...
- 线上关键验证: 当前生产未登录 quote、market-movers、earnings、pnl-benchmark 均为 `401`;生产 `index-7-QkVfBC.js`、`App-4bbHXHqM.js`、`StockDetailPage-C6NgAWBp.js`、`SettingsTab-DgJ6hFhE.js`、`settingsChangelog-B6yQmJqd.js`、`i18n-Dwcgw92X.js` 与本地 production build 字节一致,命中 v330、新短说明和更新标题,删除的长提示/复制文案/剪贴板逻辑不存在,主卡完整普通收盘价方法说明保留。
