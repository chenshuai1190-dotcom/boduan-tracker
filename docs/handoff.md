...
- 当前本地与生产设置页版本均为 `v10.7.9.341`;当前已验证生产运行时基准为 `ae9eb03e725d4a3407eca020b7832e94edd972c4`,入口 `/assets/index-DAkXD4bD.js`。
...
- 当前本地与生产设置页版本均为 `v10.7.9.341`。v341 使用 EODHD 真实 EPS/营收、现有 WebSocket 盘前行情和普通收盘价正式反应，不猜 unknown、不补 mock；v340 的财报真实 actual 美东到期局部刷新和 iOS PWA 恢复检查继续保留。
...
- 本地与生产设置页版本均为 `v10.7.9.341`；以最新提交和部署证据为准。
