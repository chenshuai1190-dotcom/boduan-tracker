...
- 最新接手补充: `v10.7.9.278` 首页当前信号文字降重已由 runtime commit `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 部署并完成线上验证。当前信号状态文字从粗体纯白改为正常字重轻灰,右侧策略状态回撤百分比同步取消粗体;保留原字号、涨跌颜色、布局和紧凑卡片结构。只改首页展示层、设置页版本/更新日志和静态护栏,行情接口、交易账本、收益快照、财报日历、RLS、独立 `/api/earnings-calendar` 鉴权和 `/api/quote` 鉴权不变。上一条 `v10.7.9.277` iOS 主屏启动黑底图已由 runtime commit `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405` 部署。
...
- 当前 GitHub `main`: 以本文件所在最新提交为准;`v10.7.9.278` 首页当前信号文字降重 runtime commit `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 已完成 production 验证。
...
- 最近交接文档刷新部署: 本文件所在最新提交为准;本次回填 `v10.7.9.278` runtime production 验证证据。
...
- 当前生产运行时基准提交: `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85`。
- 最近应用代码提交: `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 包含 `v10.7.9.278` 首页当前信号文字降重。此前 `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405` 包含 `v10.7.9.277` iOS 主屏启动黑底图;`41e77056d7a62a594830dda44eec8b4d54a51f5e` 包含 `v10.7.9.275` 首页状态圆点降噪;更早收益报表、个股详情、财报日历、BTC/指数拆分和 iOS 主屏实时链路历史见开发日志。
...
当前 GitHub main: 以 `docs/handoff.md` 所在最新提交为准;`v10.7.9.278` runtime commit `f39ed715dd96d05d9b5ff7595ae9548ee8e29b85` 已完成 production 验证
...
- `v10.7.9.278` 已上线:首页当前信号状态文字改为正常字重轻灰,策略状态回撤百分比同步取消粗体;生产 bundle marker 确认新 normal-weight class 存在、旧粗体 class 不存在
