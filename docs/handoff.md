...
- 当前本地与生产设置页版本均为 `v10.7.9.337`;当前已验证生产运行时基准为 `f3b354f06914ffede57b08c18d81bb95aa1815a7`,入口 `/assets/index-DIcYEBHf.js`。
...
- 当前本地与生产设置页版本均为 `v10.7.9.337`。v337 放大比赛本人昵称并收紧头卡;v336 完整显示千万级持仓市值;v335 统一资产页和比赛页主卡黑色;v334 精简比赛更新时间、补昵称并统一页面宽度。
