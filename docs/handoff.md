...
- 最新接手补充: `v10.7.9.277` iOS 主屏启动黑底图已由 runtime commit `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405` 部署。`v10.7.9.276` 已把 HTML/CSS 加载后的入口背景改为黑底;本轮补齐 iOS Web App 在 HTML/CSS 执行前使用的 `apple-touch-startup-image` 黑底启动图,不恢复旧的阻塞式 X MONEY 开屏。只改 PWA 启动壳和静态黑底图片,行情接口、交易账本、收益快照、财报日历、RLS、独立 `/api/earnings-calendar` 鉴权和 `/api/quote` 鉴权不变。
...
- 当前 GitHub `main`: 以本文件所在最新提交为准;`v10.7.9.277` iOS startup image runtime commit `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405` 已完成 production 验证。
...
当前 GitHub main: 以 `docs/handoff.md` 所在最新提交为准;`v10.7.9.277` runtime commit `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405` 已完成 production 验证
当前运行时基准提交: `8856f4c2a23e3ca0b7d15035702ee34d0ea9c405`
设置页版本: `v10.7.9.277`
...
- `v10.7.9.277` 已上线: `index.html` 新增 `apple-touch-startup-image` 黑底启动图;`public/splash/*.png` 为不透明 `#05070b` RGB PNG;上一版 HTML/manifest 黑底继续保留
