...
- 当前本地与生产设置页版本均为 `v10.7.9.339`;当前已验证生产运行时基准为 `0c979d522b79bea7e3c090fa737a07d38d76ace3`,入口 `/assets/index-DtGGmaQO.js`。
...
- 当前本地与生产设置页版本均为 `v10.7.9.339`。v339 把比赛权威快照更新时间固定按美东显示到分钟，强制旧纯日期缓存失效重读，并修复 iOS 主屏 PWA 恢复后不自动检查到期快照；v338 优化比赛本人信息同行与昵称完整显示;v337 放大比赛本人昵称并收紧头卡;v336 完整显示千万级持仓市值;v335 统一资产页和比赛页主卡黑色。
...
- 本地与生产设置页版本均为 `v10.7.9.339`；以最新提交和部署证据为准。
