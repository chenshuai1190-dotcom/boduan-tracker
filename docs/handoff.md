...
- 本地与生产设置页版本均为 `v10.7.9.329`;生产运行时基准为 `a2fdbb0d711732dfa118b42a8017e022bd050144`,入口 `/assets/index-Dm-Bbncn.js`。
...
- 当前本地和生产设置页版本均为 `v10.7.9.329`。v329 修复收益图表连续滑动、浮层关闭与分享卡灰边;v328 统一个股/QQQ 普通收盘价口径,补齐收益率差百分比展示。
