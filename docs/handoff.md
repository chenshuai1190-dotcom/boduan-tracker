...
- 当前本地与生产版本: `v10.7.9.325`;财报弹窗默认列表视图已完成部署和线上验证。
- `v10.7.9.325` 将首页财报公司卡片点开后的默认模式从日历视图改为列表视图;明确的日历按钮和弹窗内日历页签继续保留,财报数据、过滤、详情、API、缓存和鉴权不变。
- 最新已上线版本为 `v10.7.9.325`,production runtime `05a0b9198d386ef1cafd95d28ad7c0083a271be0`,入口 `/assets/index-BXaiQwsS.js`。
...
- 设置页版本: `v10.7.9.325`。生产运行时基准为 `05a0b9198d386ef1cafd95d28ad7c0083a271be0`,入口 `/assets/index-BXaiQwsS.js`。
...
- 线上关键验证: 未登录 quote、earnings 均为 `401`;生产 `HomeTab-fnYwGkqp.js`、`SettingsTab-KA5_cIMI.js`、`settingsChangelog-CsPcDcVn.js` 和入口与本地 build SHA-256 一致,命中财报双视图、`v10.7.9.325` 和新版中英文更新标题。
...
- 当前本地与生产设置页版本均为 `v10.7.9.325`。v325 将首页财报公司卡片默认打开列表视图;v324 更新年度路径终点文案。
- 当前 GitHub source 基准提交: 以本文件所在最新交接证据提交为准,接手后执行 `git log -1 --oneline`;最新生产运行时代码提交为 `56626e549320e6ddeffdd7a246b230593a32a1e1`。
- 当前生产运行时基准提交: `05a0b9198d386ef1cafd95d28ad7c0083a271be0`。
- 最近应用代码提交: `05a0b9198d386ef1cafd95d28ad7c0083a271be0` 包含 `v10.7.9.325` 财报弹窗默认列表视图;`56626e549320e6ddeffdd7a246b230593a32a1e1` 包含 `v10.7.9.324` 年度路径“年底目标”文案。
