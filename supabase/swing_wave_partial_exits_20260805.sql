-- Forward-only foundation for partial exits in the independent swing-wave ledger.
-- Do not apply this file without an exact production preflight and user approval.
