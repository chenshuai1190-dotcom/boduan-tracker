...
-- Canonical immediate-rebuild schema. The dated 2026-08-01 migration remains
-- the only production application artifact; this block keeps fresh installs
-- aligned without rewriting any prior migration.
...
-- Re-apply the current P&L-aware ledger trigger after the historical
-- competition compatibility definition above.
create or replace function public.bump_stock_trade_ledger_revision()
returns trigger
language plpgsql
security definer
