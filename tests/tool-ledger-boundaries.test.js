...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.221'), 'settings version badge should document the P&L report date filter dialog update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.221'), 'settings changelog should document the P&L report date filter dialog update');
