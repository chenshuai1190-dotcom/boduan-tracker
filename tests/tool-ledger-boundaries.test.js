...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.175'), 'settings version badge should document the EODHD quote basis update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.175'), 'settings changelog should document the EODHD quote basis update');
  assert.ok(settingsChangelogSource.includes('EODHD 股票价格口径统一'), 'settings changelog should describe the EODHD quote basis update');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.175'), 'settings version badge should document the latest EODHD quote basis update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.175'), 'settings changelog should document the latest EODHD quote basis update');
  assert.ok(settingsChangelogSource.includes('EODHD 股票价格口径统一'), 'settings changelog should describe the latest EODHD quote basis update');
