...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.170'), 'settings version badge should document the trade entry modal refinement');
  assert.ok(settingsChangelogSource.includes('v10.7.9.170'), 'settings changelog should document the trade entry modal refinement');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.170'), 'settings version badge should document the latest trade entry modal refinement');
  assert.ok(settingsChangelogSource.includes('v10.7.9.170'), 'settings changelog should document the latest trade entry modal refinement');
  assert.ok(settingsChangelogSource.includes('交易录入弹窗细节修正'), 'settings changelog should describe the latest trade entry modal refinement');
