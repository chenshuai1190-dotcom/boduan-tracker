...
test('main trade entry modal isolates the compact stacked formal-trade design', () => {
  ...
  assert.ok(tradeModalBlock.includes("isGenericLedgerTradeEntry ? 'min-h-0 !border-white/10 !bg-[#0b0f14] !bg-none !px-[22px] !pb-5 !pt-[22px] !text-white"), 'generic formal trade should reuse the holding-simulator black panel palette with deliberate inner spacing');
