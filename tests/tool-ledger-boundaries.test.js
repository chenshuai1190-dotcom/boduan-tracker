...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.176'), 'settings version badge should document the stock change recompute update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.176'), 'settings changelog should document the stock change recompute update');
  assert.ok(settingsChangelogSource.includes('股票涨跌幅按现价和昨收重算'), 'settings changelog should describe the stock change recompute update');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.176'), 'settings version badge should document the latest stock change recompute update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.176'), 'settings changelog should document the latest stock change recompute update');
  assert.ok(settingsChangelogSource.includes('股票涨跌幅按现价和昨收重算'), 'settings changelog should describe the latest stock change recompute update');
  assert.ok(settingsChangelogSource.includes('EODHD 股票价格口径统一'), 'settings changelog should retain the EODHD quote basis update');
