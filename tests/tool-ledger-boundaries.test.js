...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.152'), 'settings version badge should document the latest CNN gauge endpoint update');
...
test('review target page uses dark mobile cards and click action modals', () => {
  ...
  assert.ok(homeTabSource.includes('<text x="37" y="67" fill="#7f8794" fontSize="9" textAnchor="middle">0</text>'), 'CNN left endpoint label should render fully inside the SVG');
  assert.ok(homeTabSource.includes('<text x="123" y="67" fill="#7f8794" fontSize="9" textAnchor="middle">100</text>'), 'CNN right endpoint label should render fully inside the SVG');
