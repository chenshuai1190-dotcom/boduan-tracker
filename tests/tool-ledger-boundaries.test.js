...
test('Home, Trading, and Assets use continuous scoped reports', () => {
  ...
  assert.match(analysisTabCss, /\.asset-report-chart-change-decimal\s*\{[^}]*font-size:\s*\.64em;/, 'the change decimal should retain precision at the same subordinate scale as the primary amount');
