...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.194'), 'settings version badge should document the iOS PWA stock realtime resume update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.194'), 'settings changelog should document the iOS PWA stock realtime resume update');
  assert.ok(settingsChangelogSource.includes('iOS 主屏股票实时恢复'), 'settings changelog should describe the iOS PWA stock realtime resume update');
