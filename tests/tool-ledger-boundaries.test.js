...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.191'), 'settings version badge should document the English header holdings copy update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.191'), 'settings changelog should document the English header holdings copy update');
  assert.ok(settingsChangelogSource.includes('英文头卡持仓文案收窄'), 'settings changelog should describe the English header holdings copy update');
