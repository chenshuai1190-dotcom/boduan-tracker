...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.198'), 'settings version badge should document the iOS PWA startup snapshot warmup update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.198'), 'settings changelog should document the iOS PWA startup snapshot warmup update');
