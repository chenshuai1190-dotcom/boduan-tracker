...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.182'), 'settings version badge should document the iOS realtime resume reconnect update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.182'), 'settings changelog should document the iOS realtime resume reconnect update');
  assert.ok(settingsChangelogSource.includes('iOS 实时行情恢复重连'), 'settings changelog should describe the iOS realtime resume reconnect update');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.182'), 'settings version badge should document the latest iOS realtime resume reconnect update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.182'), 'settings changelog should document the latest iOS realtime resume reconnect update');
  assert.ok(settingsChangelogSource.includes('iOS 实时行情恢复重连'), 'settings changelog should describe the latest iOS realtime resume reconnect update');
