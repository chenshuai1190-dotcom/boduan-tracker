...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.213'), 'settings version badge should document the P&L report visual tune update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.213'), 'settings changelog should document the P&L report visual tune update');
  assert.ok(settingsChangelogSource.includes('收益报表视觉收紧'), 'settings changelog should describe the P&L report visual tune update');
