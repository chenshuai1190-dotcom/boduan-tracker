...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.189'), 'settings version badge should document the close-locked daily pnl update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.189'), 'settings changelog should document the close-locked daily pnl update');
