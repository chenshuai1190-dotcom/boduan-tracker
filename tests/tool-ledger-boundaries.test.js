...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.206'), 'settings version badge should document the BTC connection status stability update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.206'), 'settings changelog should document the BTC connection status stability update');
  assert.ok(settingsChangelogSource.includes('BTC 连接态稳定'), 'settings changelog should describe the BTC connection status stability update');
