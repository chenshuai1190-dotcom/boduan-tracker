...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.190'), 'settings version badge should document the gray close-lock label update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.190'), 'settings changelog should document the gray close-lock label update');
