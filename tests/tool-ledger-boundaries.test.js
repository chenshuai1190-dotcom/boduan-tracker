...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.158'), 'settings version badge should document the latest extended-hours realtime protection fix');
...
test('review target page uses dark mobile cards and click action modals', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.158'), 'settings version badge should document the extended-hours realtime protection fix');
