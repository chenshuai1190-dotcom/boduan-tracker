...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.180'), 'settings version badge should document the iOS PWA resume quote refresh update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.180'), 'settings changelog should document the iOS PWA resume quote refresh update');
  assert.ok(settingsChangelogSource.includes('iOS 主屏幕恢复刷新加固'), 'settings changelog should describe the iOS PWA resume quote refresh update');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.180'), 'settings version badge should document the latest iOS PWA resume quote refresh update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.180'), 'settings changelog should document the latest iOS PWA resume quote refresh update');
  assert.ok(settingsChangelogSource.includes('iOS 主屏幕恢复刷新加固'), 'settings changelog should describe the latest iOS PWA resume quote refresh update');
  assert.ok(settingsChangelogSource.includes('行情请求禁用浏览器缓存'), 'settings changelog should retain the no-cache quote refresh update');
  assert.ok(settingsChangelogSource.includes('股票行情即时刷新'), 'settings changelog should retain the quick quote refresh update');
  assert.ok(settingsChangelogSource.includes('EODHD 股票价格口径统一'), 'settings changelog should retain the EODHD quote basis update');
