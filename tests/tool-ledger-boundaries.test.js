...
test('main trade entry modal uses compact four-step buy sell submission flow', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.184'), 'settings version badge should document the market red color update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.184'), 'settings changelog should document the market red color update');
...
test('asset and review module cards do not keep legacy scale interactions', () => {
  ...
  assert.ok(settingsTabSource.includes('v10.7.9.184'), 'settings version badge should document the latest market red color update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.184'), 'settings changelog should document the latest market red color update');
  assert.ok(settingsChangelogSource.includes('v10.7.9.183'), 'settings changelog should retain the daily pnl baseline protection update');
