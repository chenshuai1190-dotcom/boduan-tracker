...
test('Home margin risk uses a standalone page while keeping the bottom navigation', () => {
  ...
  assert.ok(appSource.includes('hideBottomNavigation = isPnlReportPage || isPnlSharePage || isStockPnlReportPage;'), 'the P&L report, share page, and stock P&L report should hide the bottom tabs');
